...
class TestUserPostsDetails:
    ...
    def post_setup(self, person_fixture, persons_fixture):
        ...
        self.person_dict = {person_fixture.id: person_fixture, self.person1.id: self.person1,
                            self.person2.id: self.person2, self.person3.id: self.person3}
        self.reactions1_for_post = Reaction.objects.create(person_id=self.person1.id,
                                                           post_id=self.post.id,
                                                           react_type=self.reaction_type1)
        self.reactions2_for_post = Reaction.objects.create(person_id=self.person2.id,
                                                           post_id=self.post.id,
                                                           react_type=self.reaction_type2)
        self.reactions3_for_post = Reaction.objects.create(person_id=self.person3.id,
                                                           post_id=self.post.id,
                                                           react_type=self.reaction_type3)
        self.reactions_dict = {self.reactions1_for_post.id: self.reactions1_for_post,
    ...
    def post_details_setup(self, post_setup):
        ...
        self.reaction1_for_comment1 = Reaction.objects.create(person_id=self.person1.id,
                                                              comment_id=self.comment1_for_post.id,
                                                              react_type=self.reaction_type1)
        self.reaction2_for_comment1 = Reaction.objects.create(person_id=self.person2.id,
                                                              comment_id=self.comment1_for_post.id,
                                                              react_type=self.reaction_type2)
        self.reaction3_for_comment1 = Reaction.objects.create(person_id=self.person3.id,
                                                              comment_id=self.comment1_for_post.id,
                                                              react_type=self.reaction_type3)
        self.reactions_dict[self.reaction1_for_comment1.id] = self.reaction1_for_comment1
        self.reactions_dict[self.reaction2_for_comment1.id] = self.reaction2_for_comment1
        self.reactions_dict[self.reaction3_for_comment1.id] = self.reaction3_for_comment1
        self.reply1_for_comment1_content = "reply for comment 1"
        self.reply2_for_comment1_content = "reply2 for comment 1"
        self.reply1_for_comment1 = Comment.objects.create(person_id=self.person2.id,
        ...
        self.reply2_for_comment1 = Comment.objects.create(person_id=self.person3.id,
