...
class TestCreatePost(unittest.TestCase):
    ...
    def test_create_post_reactions_response(self):
        ...
        person_with_reaction_dto_1 = PersonWithReactionDto(1, "username1",
                                                           "https://www.profilePic.com",
                                                           reaction_dto_1)
        person_with_reaction_dto_2 = PersonWithReactionDto(2, "username2",
                                                           "https://www.profilePic.com",
                                                           reaction_dto_2)
        person_with_reaction_dto_3 = PersonWithReactionDto(3, "username3",
                                                           "https://www.profilePic.com",
                                                           reaction_dto_3)

        person_with_reaction_dto_list = [person_with_reaction_dto_1,
                                         person_with_reaction_dto_2,
        ...
        response = presenter.create_post_reactions_response(
            person_with_reaction_dto_list)
        ...
        assert response_reaction[
                   'profile_pic_url'] == reaction_details_dto.profile_url_pic
        assert response_reaction[
                   'reaction_type'] == reaction_details_dto.reaction.reaction_type
