...
class TestReactToPost(unittest.TestCase):
    ...
    def test_react_to_post_returns_reactions_id(self):
        ...
        mock_storage.post_reaction_exists_or_not.side_effect = ObjectDoesNotExist
        ...
        mock_storage.post_reaction_exists_or_not.assert_called_once_with(reacted_by_id, post_id)
    ...
    def test_react_to_post_when_reactions_by_same_person_with_same_reaction_type(self):
        ...
        mock_storage.post_reaction_exists_or_not.return_value = mock_react_dto
