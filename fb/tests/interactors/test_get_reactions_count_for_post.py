...
class GetReactionsCountForPost(unittest.TestCase):
    ...
    def test_get_reactions_counts_for_posts_interactor_returns_count(self):
        ...
        mock_json_presenter.get_reactions_count_for_posts_response.return_value = response
        ...
        mock_json_presenter.get_reactions_count_for_posts_response.assert_called_once_with(count)
