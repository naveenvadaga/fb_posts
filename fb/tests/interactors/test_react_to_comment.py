...
class TestReactToCommment(unittest.TestCase):
    ...
    def test_react_to_comment_returns_reactions_id(self):
        ...
        mock_storage.comment_reaction_exists_or_not.side_effect = ObjectDoesNotExist
        mock_storage.react_to_comment_interactor.return_value = reaction_id
        ...
        response_from_react_to_comment = react_interactor.react_to_comment_interactor(reacted_by_id,
                                                                                      comment_id,
                                                                                      reaction_type)
        mock_storage.comment_reaction_exists_or_not.assert_called_once_with(reacted_by_id,
                                                                            comment_id)
        mock_storage.react_to_comment_interactor.assert_called_once_with(reacted_by_id, comment_id,
                                                                         reaction_type)
    ...
    def test_react_to_comment_when_reactions_by_same_person_with_same_reaction_type(self):
        ...
        mock_storage.comment_reaction_exists_or_not.return_value = mock_react_dto
