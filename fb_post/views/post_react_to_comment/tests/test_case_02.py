...
class TestCase02PostReactToCommentAPITestCase(CustomAPITestCase):
    app_name = APP_NAME
    ...
    def test_case(self):
        super(TestCase02PostReactToCommentAPITestCase, self).setupUser('username', 'password')
    ...
    def _assert_snapshots(self, response):
        super(TestCase02PostReactToCommentAPITestCase, self)._assert_snapshots(response)
        from fb_post.models_utility_functions import Reaction
